...
public class Test2 {
    public static void main(String[] args) {
        ...
        Person person = new Person("gsggs", "12 Bell street",
                "3473339999", "john12@aol.com");

        Student student = new Student("fhfdhgdf", "100 Town Ave", "111111",
                "mary100@aol.com", Student.FRESHMAN);

        Employee employee = new Employee("fgdagfdg", "34 West street", "6111111111111",
                "mike80@aol.com", 910, 60000);

        Faculty faculty = new Faculty("gfgggggggggg", "28 Well street", "4133333333",
                "sue28@aol.com", 101, 50000, "4pm to 6pm", "Professor");

        Staff staff = new Staff("dfggs", "90 Country road", "2030000000",
